...
namespace BuildCast.DataModel
{
    ...
    public class FeedStore
    {
        ...
        {
            // Developer
            AllFeeds.Add(new Feed(new Uri("https://s.ch9.ms/Events/Build/2018/RSS"), "Build 2018 Sessions", "Sessions for Build 2018", new Uri("https://f.ch9.ms/thumbnail/c2635543-13a9-4082-892a-1da55baa9bce.png"), "Microsoft"));
            AllFeeds.Add(new Feed(new Uri("https://s.ch9.ms/Events/Build/2018/RSS"), "Build 2018 Sessions", "Sessions for Build 2018", new Uri("http://files.channel9.msdn.com/thumbnail/dc1f8b69-a4a3-422c-b7a7-b29a9183bc79.jpg"), "Microsoft"));

            AllFeeds.Add(new Feed(new Uri("https://www.rsssearchhub.com/feed/68bdb27f643b0e7b7ddb541458f16460/net-rocks"), "DNR", "Sessions for DNR", new Uri("https://d3dthqtvwic6y7.cloudfront.net/podcast-covers/000/031/966/medium/net-rocks.jpg"), "DNR"));
