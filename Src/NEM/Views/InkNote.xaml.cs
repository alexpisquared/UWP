...
namespace NEM.Views
{
    public sealed partial class InkNote : Page, IPageWithViewModel<InkNoteViewModel>
    {
        ...
        private NEM.DataModel.InkNote _inkNote;
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            _inkNote = e.Parameter as NEM.DataModel.InkNote;
        ...
        private async Task LoadExisting(NEM.DataModel.InkNote meme)
        {
        ...
        private async void DataRequested(DataTransferManager sender, DataRequestedEventArgs e)
        {
            ...
            request.Data.Properties.ApplicationName = "NEM";
