...
namespace NEM.Views
{
    ...
    public sealed partial class NavigationRoot : Page
    {
        ...
        private void AppNavFrame_Navigated(object sender, NavigationEventArgs e)
        {
            ...
            {
                case Type c when e.SourcePageType == typeof(HomeAbout): /**/ ((NavigationViewItem)navview.MenuItems[0]).IsSelected = true; break;
                case Type c when e.SourcePageType == typeof(Home):      /**/ ((NavigationViewItem)navview.MenuItems[1]).IsSelected = true; break;
                case Type c when e.SourcePageType == typeof(Player):    /**/ ((NavigationViewItem)navview.MenuItems[2]).IsSelected = true; break;
                case Type c when e.SourcePageType == typeof(Favorites): /**/ ((NavigationViewItem)navview.MenuItems[3]).IsSelected = true; break;
                case Type c when e.SourcePageType == typeof(Notes):     /**/ ((NavigationViewItem)navview.MenuItems[4]).IsSelected = true; break;
                case Type c when e.SourcePageType == typeof(Downloads): /**/ ((NavigationViewItem)navview.MenuItems[5]).IsSelected = true; break;
            }
        }
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                _navigationService.NavigateToHomesAsync();
        ...
        private void Navview_ItemInvoked(NavigationView sender, NavigationViewItemInvokedEventArgs args)
        {
            ...
            {
                case "Home / About":            /**/ _navigationService.NavigateToHomesAsync(); break;
                case "Main Enrollment Stages":  /**/ _navigationService.NavigateToPodcastsAsync(); break;
                case "Lock Control Operations": /**/ _navigationService.NavigateToNowPlayingAsync(); break;
                case "Favorites":               /**/ _navigationService.NavigateToFavoritesAsync(); break;
                case "Notes":                   /**/ _navigationService.NavigateToNotesAsync(); break;
                case "Downloads":               /**/ _navigationService.NavigateToDownloadsAsync(); break;
            }
        }
...
///compilation takes:
/// 25 sec on asus2
/// 15 sec on woho (upgrade to 15.5.1 did not help)